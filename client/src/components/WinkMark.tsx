...
export function WinkMark({
  ...
  return (
    ...
    >
      ...
      <path d="M88 70 Q100 56 112 70" stroke="#FDF8FF" strokeWidth="10" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M50 96 Q80 124 110 96" stroke="#FDF8FF" strokeWidth="10" fill="none" strokeLinecap="round" />
      {sparkle && (
        <path d="M130 32 L133 42 L143 45 L133 48 L130 58 L127 48 L117 45 L127 42 Z" fill="#FACC15" />
      )}
    </svg>
  );
}
